...
import { Mail, ArrowRight, Info, LogIn, Loader2, AlertCircle, Shield } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center">
          <Image src="/omnia-mark.png" alt="Omnia Protocol" width={56} height={56} className="mx-auto mb-5" priority />
          <h1 className="font-mono text-2xl lowercase tracking-wide mb-2">omnia protocol</h1>
      ...
      <div className="max-w-md w-full relative">
        ...
        {callbackError && (
          <div className="mt-4 p-3 bg-destructive/10 border border-destructive/20 rounded-xl text-sm text-destructive flex items-start gap-2">
            ...
            <span>
              Sign-in didn't complete ({callbackError}). Check your Supabase project's
